...
//Main CP
$txt['main_description'] = 'Bienvenido(a), <strong>'. $user_info['username'] .'</strong>!. Este es tu "<strong>Centro de Administración del Ultimate Portal</strong>". <br />
Aquí puedes modificar: 
	<ul>
		<li>Configuración General del Portal</li>
...
Si tienes algun problema, por favor revisa la página de <strong>Manual en Linea</strong>. Si esa información no te sirve, puedes visitarnos para solicitar ayuda acerca de tu problema.';

$txt['main_blocks_title'] = 'Administración de Bloques';
...
$txt['main_about_description'] = 'Modulo por defecto del Ultimate Portal, con este modulo podras visualizar el Equipo o Staff de la tu Pagina Web, asi como Información Extra.';
...
$txt['ultport_admin_title'] = 'Ultimate Portal - Centro de Administración';
$txt['ultport_preferences_title'] = 'Preferencias';
$txt['ultport_blocks_title'] = 'Administración de Bloques';

//Preferences
$txt['ultport_admin_preferences_title'] = 'Centro de Administración';
$txt['ultport_admin_preferences_description'] = 'Area en la que se podra configurar por completo el Ultimate Portal';
$txt['ultport_admin_main_title'] = 'Información';
...
//Admin Gral Settings
$txt['ultport_admin_gral_settings_title'] = 'Configuración General';
...
$txt['ultport_admin_lang_maintenance_admin'] = 'Administración del Idioma';
$txt['lang_maintenance_duplicate_title'] = 'Duplicación de Idioma';
...
$txt['ultport_admin_lang_maintenance_warning'] = 'Acuerdese de Limpiar la Cache del Foro cuando edite un Archivo de Idioma
												...
												<br/>&nbsp;&nbsp;Es la última Opción de Este panel de Control.';
...
$txt['ultport_admin_permissions_settings_title'] = 'Configuración de Permisos';
...
$txt['ultport_admin_mainlinks_url'] = 'Dirección Web';
$txt['ultport_admin_mainlinks_position'] = 'Posición';
...
$txt['seo_robots_title'] = 'Configuración Robots.txt';
$txt['seo_config'] = 'Configuración General';
$txt['seo_robots_txt'] = '<strong>Configuración Robots.txt</strong>
...
$txt['seo_google_verification_code'] = '<strong>Introduzca el Nombre del Archivo html para Verificar su sitio en Google</strong>
							<br />Esta opción le permitirá crear el archivo.html que google necesita para que usted pueda verificar su sitio
...
$txt['ultport_add_bk_html_titles'] = 'Creación de bloque HTML';
$txt['ultport_add_bk_php_titles'] = 'Creación de bloque PHP';
...
$txt['ultport_mb_title2'] = 'Título del Multibloque';
$txt['ultport_mb_position'] = 'Posición del Multibloque | Cabezera | Pie de página';
...
$txt['ultport_mbk_title'] = '<strong>Multique sin título?</strong>
    <br />De esta manera puedes determinar si el Multibloque tendrá o no un título.';
...
$txt['ultport_mbk_style'] = '<strong>MultiBloque con estilo?</strong>
    <br />De esta manera puedes determinar si el Multibloque tendrá un estilo.';
$txt['ultport_mb_step'] = 'Paso';
$txt['ultport_mb_organization'] = '<strong>Organización</strong>
    <br />Organiza tu bloque para que aparezca donde quieras.';
$txt['ultport_mb_row'] = 'Fila';
$txt['ultport_mb_column'] = 'Columna';
$txt['ultport_mbk_position'] = 'Posición en el MultiBloque';
$txt['ultport_mb_edit'] = 'Editar Multibloque';
$txt['ultport_mb_multiheader'] = 'Posición de la cabecera del MultiBloque';
$txt['ultport_mb_footer'] = 'Posición del pie de pagina del MultiBloque';
$txt['ultport_mb_delete'] = '&iquest;Estás seguro que quieres borrar el MultiBloque?';
...
<br />
De esta manera puedes reducir la carga (las peticiones a la base de datos es solo de 1 que ves cada 30 minutos) de Ultimate Portal, usando el método de cache por defecto de SMF.
<br />
<strong>Con esta opción activada debes vaciar la cache del foro cada vez que cambies, agregues, borres bloques o modulos; para que estos cambios hagan efecto.</strong>.';
