...
//Main CP
$txt['main_description'] = 'Bienvenido(a), <strong>'. $user_info['username'] .'</strong>!. Este es tu "<strong>Centro de Administraci&oacute;n del Ultimate Portal</strong>". <br />
Aqu&iacute; puedes modificar: 
	<ul>
		<li>Configuraci&oacute;n General del Portal</li>
...
Si tienes algun problema, por favor revisa la p&aacute;gina de <strong>Manual en Linea</strong>. Si esa informaci&oacute;n no te sirve, puedes visitarnos para solicitar ayuda acerca de tu problema.';

$txt['main_blocks_title'] = 'Administraci&oacute;n de Bloques';
...
$txt['main_about_description'] = 'Modulo por defecto del Ultimate Portal, con este modulo podras visualizar el Equipo o Staff de la tu Pagina Web, asi como Informaci&oacute;n Extra.';
...
$txt['ultport_admin_title'] = 'Ultimate Portal - Centro de Administraci&oacute;n';
$txt['ultport_preferences_title'] = 'Preferencias';
$txt['ultport_blocks_title'] = 'Administraci&oacute;n de Bloques';

//Preferences
$txt['ultport_admin_preferences_title'] = 'Centro de Administraci&oacute;n';
$txt['ultport_admin_preferences_description'] = 'Area en la que se podra configurar por completo el Ultimate Portal';
$txt['ultport_admin_main_title'] = 'Informaci&oacute;n';
...
//Admin Gral Settings
$txt['ultport_admin_gral_settings_title'] = 'Configuraci&oacute;n General';
...
$txt['ultport_admin_lang_maintenance_admin'] = 'Administraci&oacute;n del Idioma';
$txt['lang_maintenance_duplicate_title'] = 'Duplicaci&oacute;n de Idioma';
...
$txt['ultport_admin_lang_maintenance_warning'] = 'Acuerdese de Limpiar la Cache del Foro cuando edite un Archivo de Idioma
												...
												<br/>&nbsp;&nbsp;Es la &uacute;ltima Opci&oacute;n de Este panel de Control.';
...
$txt['ultport_admin_permissions_settings_title'] = 'Configuraci&oacute;n de Permisos';
...
$txt['ultport_admin_mainlinks_url'] = 'Direcci&oacute;n Web';
$txt['ultport_admin_mainlinks_position'] = 'Posici&oacute;n';
...
$txt['seo_robots_title'] = 'Configuraci&oacute;n Robots.txt';
$txt['seo_config'] = 'Configuraci&oacute;n General';
$txt['seo_robots_txt'] = '<strong>Configuraci&oacute;n Robots.txt</strong>
...
$txt['seo_google_verification_code'] = '<strong>Introduzca el Nombre del Archivo html para Verificar su sitio en Google</strong>
							<br />Esta opci&oacute;n le permitir&aacute; crear el archivo.html que google necesita para que usted pueda verificar su sitio
...
$txt['ultport_add_bk_html_titles'] = 'Creaci&oacute;n de bloque HTML';
...
$txt['ultport_mb_title2'] = 'T&iacute;tulo del Multibloque';
$txt['ultport_mb_position'] = 'Posici&oacute;n del Multibloque | Cabezera | Pie de p&aacute;gina';
...
$txt['ultport_mbk_title'] = '<strong>Multique sin t&iacute;tulo?</strong>
    <br />De esta manera puedes determinar si el Multibloque tendr&aacute; o no un t&iacute;tulo.';
...
$txt['ultport_mbk_style'] = '<strong>MultiBloque con estilo?</strong>
    <br />De esta manera puedes determinar si el Multibloque tendr&aacute; un estilo.';
$txt['ultport_mb_step'] = 'Paso';
$txt['ultport_mb_organization'] = '<strong>Organizaci&oacute;n</strong>
    <br />Organiza tu bloque para que aparezca donde quieras.';
$txt['ultport_mb_row'] = 'Fila';
$txt['ultport_mb_column'] = 'Columna';
$txt['ultport_mbk_position'] = 'Posici&oacute;n en el MultiBloque';
$txt['ultport_mb_edit'] = 'Editar Multibloque';
$txt['ultport_mb_multiheader'] = 'Posici&oacute;n de la cabecera del MultiBloque';
$txt['ultport_mb_footer'] = 'Posici&oacute;n del pie de pagina del MultiBloque';
$txt['ultport_mb_delete'] = '&iquest;Est&aacute;s seguro que quieres borrar el MultiBloque?';
...
<br />
De esta manera puedes reducir la carga (las peticiones a la base de datos es solo de 1 que ves cada 30 minutos) de Ultimate Portal, usando el m&eacute;todo de cache por defecto de SMF.
<br />
<strong>Con esta opci&oacute;n activada debes vaciar la cache del foro cada vez que cambies, agregues, borres bloques o modulos; para que estos cambios hagan efecto.</strong>.';
