...
$txt['ultport_no_rows_title'] = 'Informaci&oacute;n.';
...
$txt['ultport_admin_up_limit'] = '<strong>Cantidad de Aportes por Pagina?</strong>
							<br />
							Aqui se establece el N&uacute;mero de Aportes por paginas, para mostrar dentro del bloque (p&aacute;gina de inicio).
...
$txt['ultport_admin_up_field_description'] = 'Descripci&oacute;n del Tema';
...
$txt['ultport_admin_extra_field_title'] = 'Descripci&oacute;n';
...
$txt['ultport_admin_add_extra_field_title'] = '<strong>Descripci&oacute;n</strong>
...
$txt['user_posts_perms'] = 'Administraci&oacute;n de Permisos';
...
$txt['ultport_admin_news_limit'] = '<strong>Limite de Visualizacion por pagina</strong>
							<br />
							Aqui se establece el N&uacute;mero de Noticias por paginas, para mostrar dentro del bloque (p&aacute;gina de inicio, por defecto 10 Noticias por Pagina)';					
...
$txt['ultport_admin_news_sect_position'] = 'Posici&oacute;n';
$txt['ultport_admin_news_sect_action'] = 'Acciones';
$txt['ultport_admin_add_sect_title'] = 'Agregando Nueva Secci&oacute;n';
$txt['ultport_admin_edit_sect_title'] = 'Editando Secci&oacute;n';
...
$txt['ultport_admin_news_add_sect_position'] = '<strong>Posici&oacute;n</strong>
...
$txt['ultport_admin_bn_limit'] = '<strong>Limite de Visualizacion</strong>
							<br />
							Aqui se establece el N&uacute;mero de Noticias para mostrar dentro del bloque 
							<br />(p&aacute;gina de inicio)';
$txt['ultport_admin_bn_lenght'] = '<strong>Maximo numero de Caracteres</strong>
							<br />
							Aqui se establece el Maximo N&uacute;mero de Caracteres que tendra cada Noticia visualizada. Para no establecer limite dejar vacio.';
...
$txt['up_down_settings_tab'] = 'Configuraci&oacute;n General';
$txt['up_down_section_tab'] = 'Administrar Secciones';

//Section Download Module - Description
$txt['up_down_settings_descrip'] = 'Area de Configuraci&oacute;n General del Modulo Descargas';
...
$txt['up_down_file_max_size'] = 'M&aacute;ximo Tama&ntilde;o del Archivo para subir en Kilobytes (0 = Ning&uacute;n L&iacute;mite). 
...
$txt['up_down_no_approved_file'] = 'No requiere de Aprobaci&oacute;n del Administrador';
$txt['up_down_yes_approved_file'] = 'Si requiere de Aprobaci&oacute;n del Administrador';
...
$txt['up_down_sect_perms'] = 'Grupos Permitidos para ver la Secci&oacute;n';
$txt['up_down_sect_board'] = 'Foro de la Seccion.';
$txt['up_down_sect_no_board'] = 'Desactivado';
$txt['up_down_sect_total_files'] = 'Cantidad de Archivos de la Secci&oacute;n';
...
$txt['up_down_manage_sect_perms'] = '<strong>Grupos Permitidos para ver la Secci&oacute;n</strong>
								<br />
...
$txt['up_down_manage_sect_description'] = '<strong>Descripci&oacute;n de la Secci&oacute;n</strong>
								<br />Una Breve descripci&oacute;n para la seccion creada. Solo acepta BBCode, NO HTML';					

//Internal Page Module
$txt['ipage_title'] = 'Paginas Internas';
$txt['ipage_settings_title'] = 'Configuraciones';
$txt['ipage_settings_description'] = 'Configuraci&oacute;n General del Modulo Paginas Internas.';
...
$txt['up_about_settings_tab'] = 'Configuraci&oacute;n General';
...
$txt['up_aboutus_settings_descrip'] = 'Area de Configuraci&oacute;n General del <strong>Modulo Quienes Somos</strong>';

//Section FAQ Module - Titles | Tabs
$txt['up_faq_title'] = 'Preguntas Frecuentes';
$txt['up_faq_config'] = 'Configuraci&oacute;n General';
...
$txt['up_faq_title_page'] = 'Titulo que tendra la Pagina Principal del Modulo
							<br/>No acepta BBCode';
$txt['up_faq_small_description'] = 'Breve Descripci&oacute;n de lo que se quiere presentar en la P&aacute;gina del <strong>Modulo Preguntas Frecuentes</strong>
							<br/>No acepta BBCode';
