...
$limit = !empty($ultimateportalSettings['board_news_limit']) ? $ultimateportalSettings['board_news_limit'] : 10;
$length = !empty($ultimateportalSettings['board_news_lenght']) ? $ultimateportalSettings['board_news_lenght'] : ''; 
$boards = array();
